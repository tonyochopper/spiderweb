...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if changedata == 1
    data = init_ms_sys_data_sprial(8,6,0);
elseif changedata == 2
    data = init_ms_sys_data_sprial(8,6,0.05);
elseif changedata == 3
    data = init_ms_sys_data_sprial(8,6,0.1);
elseif changedata == 4
    data = init_ms_sys_data_sprial(8,6,0.15);
elseif changedata == 5
    data = init_ms_sys_data_sprial(8,6,0.2);
elseif changedata == 6
    data = init_ms_sys_data_sprial(8,6,0.25);
elseif changedata == 7
    data = init_ms_sys_data_sprial(8,6,0.3);
elseif changedata == 8
    data = init_ms_sys_data_sprial(8,6,0.35);
elseif changedata == 9
    data = init_ms_sys_data_sprial(8,6,0.4);
